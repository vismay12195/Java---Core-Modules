...
<title>User Authenticated Portfolio</title>
<!-- Favicon-->
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To my Portfolio page</h1>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">This is a free bootstrap theme created by
						Start Bootstrap. It includes the complete source files
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						1095 Baker Street, Peterborough, ON K9H 7R3
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<div class="col-lg-4">
					...
					<p class="lead mb-0">
						This is a free to use, MIT licensed Bootstrap theme created
